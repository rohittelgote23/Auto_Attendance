...
def Recognizer(details):
	...
	while True:	
		...
		for face_encoding in face_encodings:
			...
			try:
				matches = face_recognition.compare_faces(known_face_encodings, np.array(face_encoding), tolerance = 0.54)
		...
		if len(face_names) == 0:
			for (top,right,bottom,left) in face_locations:
				...
				cv2.putText(frame, 'Unknown', (left, top), font, 1.0, (255,255,255),1)
		else:
